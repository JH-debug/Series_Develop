...
test (
    'main.js sum() 테스트',
    function() {
        expect(main.sum(10, 20)).toBe(expected, 30)
    }
)
...
test(
    'calculatesum',
    function() {
        expect(main.calculatesum(30)).toBe(expected, 45)
    }
)
...
test(
    ...
    function() {
        ...
        expect(main.countberry(fruitsBasket)).toBe(expected, 2)
    }
)
...
test(
    ...
    function() {
        ...
        expect(main.countberry(fruitsBasket)).toBe(expected, 0)
    }
)
